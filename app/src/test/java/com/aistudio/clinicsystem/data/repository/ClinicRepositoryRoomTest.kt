...
class ClinicRepositoryRoomTest {
    ...
    @Test
    fun `insertAppointment saves to Room`() =
        runBlocking {
            val appointment =
                AppointmentEntity(
                    id = "1",
    ...
    @Test
    fun `insertMedicalRecord saves to Room`() =
        runBlocking {
            val record =
    ...
    @Test
    fun `getAppointmentsForPatient returns only patient appointments`() =
        runBlocking {
    ...
    @Test
    fun `updateAppointment changes status`() =
        runBlocking {
            val appointment =
                AppointmentEntity(
                    id = "1",
    ...
    @Test
    fun `deleteAppointment removes from Room`() =
        runBlocking {
            val appointment =
                AppointmentEntity(
                    id = "1",
    ...
    @Test
    fun `allAppointments flow emits all appointments`() =
        runBlocking {
            repository.insertAppointment(
                AppointmentEntity(
                    id = "1",
    ...
    @Test
    fun `addSyncLog and recentLogs flow work`() =
        runBlocking {
    ...
    @Test
    fun `clearSensitiveDataForPatient removes appointments and records`() =
        runBlocking {
