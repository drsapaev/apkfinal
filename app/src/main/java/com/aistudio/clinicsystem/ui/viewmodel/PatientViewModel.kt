...
class PatientViewModel
    ...
    constructor(
        ...
        val patientAppointments: StateFlow<List<AppointmentEntity>> =
            combine(
        ...
        val patientRecords: StateFlow<List<MedicalRecordEntity>> =
            combine(
                ...
                result
                    .onSuccess {
                        ...
                        repository.addSyncLog(
                            appContext.getString(com.aistudio.clinicsystem.R.string.vm_tg_link_error) + ": " +
                                (error.localizedMessage ?: appContext.getString(com.aistudio.clinicsystem.R.string.vm_error_unknown)),
                            "SYSTEM_SYNC",
                        )
                    }
            }
            ...
            viewModelScope.launch {
                ...
                result
                    .onSuccess {
                        ...
                        repository.addSyncLog(
                            appContext.getString(com.aistudio.clinicsystem.R.string.vm_tg_unlink_error) + ": " +
                                (error.localizedMessage ?: appContext.getString(com.aistudio.clinicsystem.R.string.vm_error_unknown)),
                            "SYSTEM_SYNC",
                        )
                    }
            ...
            viewModelScope.launch {
                ...
                result
                    .onSuccess {
                        ...
                        repository.addSyncLog(
                            appContext.getString(com.aistudio.clinicsystem.R.string.vm_tg_test_error) + " — " +
                                (error.localizedMessage ?: appContext.getString(com.aistudio.clinicsystem.R.string.vm_error_unknown)),
                            "SYSTEM_SYNC",
                        )
                    }
